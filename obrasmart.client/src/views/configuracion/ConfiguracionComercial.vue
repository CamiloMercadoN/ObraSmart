<template>
  <div class="flex flex-column gap-3 md:gap-4 pb-4 h-full max-w-50rem mx-auto">
    ...
    <!-- Cabecera y Acciones -->
    <div class="app-panel p-3 md:p-4 flex flex-column md:flex-row justify-content-between md:align-items-center gap-3">
      <div class="flex align-items-center gap-3">
        ...
        <div>
          <h2 class="m-0 app-text text-lg md:text-xl font-bold">Configuración Comercial</h2>
          <span class="app-text-muted text-sm">Personaliza los datos base para tus cotizaciones</span>
        </div>
      </div>
    ...
    <div class="app-panel p-3 md:p-4">
      <div class="grid formgrid p-fluid">
        ...
        <!-- Logo -->
        <div class="field col-12 mb-4 border-bottom-1 app-border-color pb-4">
          <label class="font-bold block mb-3 app-text">Logo de la Empresa</label>
          <div class="flex flex-column sm:flex-row align-items-center gap-4">

            <!-- Preview del Logo -->
            <div class="app-surface-subtle border-1 app-border-color border-round flex align-items-center justify-content-center overflow-hidden" style="width: 120px; height: 120px;">
              <img v-if="logoPreview" :src="logoPreview" alt="Logo Empresa" class="w-full h-full" style="object-fit: contain;" />
              <i v-else class="pi pi-image text-4xl app-text-muted"></i>
            </div>
            ...
            <div class="flex flex-column gap-2 text-center sm:text-left">
              ...
              <small class="app-text-muted">Formato JPG o PNG. Tamaño máximo 2MB.</small>
            </div>
          </div>
        </div>
        ...
        <div class="field col-12">
          <label for="razonSocial" class="font-bold block mb-2 app-text">Razón Social o Nombre <span class="text-red-500">*</span></label>
